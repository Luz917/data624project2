...
For a larger version of this plot, [click here](https://github.com/Luz917/data624project2/blob/Sherranette/pairs-result.png)
...
plot_correlation(na.omit(student_data), maxcat = 5L)
```
