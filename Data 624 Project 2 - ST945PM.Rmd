...
Here, we build the partial least square model. Rsquared was used to select the optimal model. 
...
As you can see, Random Forest model is the best performing model based on lowest RMSE. It also happens to be the model with the higest r-squared as well. 
